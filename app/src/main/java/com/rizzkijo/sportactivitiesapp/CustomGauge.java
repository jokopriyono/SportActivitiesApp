...
public class CustomGauge extends View {
    ...
    public CustomGauge(Context context, AttributeSet attrs) {
        ...
        // divider options
        float dividerSize = a.getFloat(R.styleable.CustomGauge_gaugeDividerSize, 0f);
...
//        paint2 = mPaint;
//        paint2.setColor(mStrokeColor+1);
//        paint2.setStrokeWidth(mStrokeWidth-20);
//        rectF2 = mRect;
...
//        Paint p = mPaint;
//        p.setShadowLayer(30, 0, 0, Color.LTGRAY);
